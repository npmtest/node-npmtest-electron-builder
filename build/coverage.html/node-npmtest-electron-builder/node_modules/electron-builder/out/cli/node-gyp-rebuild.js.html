...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-builder/node_modules/electron-builder/out/cli/node-gyp-rebuild.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-builder/node_modules/electron-builder/out/cli/node-gyp-rebuild.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-builder/node_modules/electron-builder/out/cli/</a> &#187; node-gyp-rebuild.js</div>
</div>
<div class="body">
...
let main = (() =&gt; {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
        ...
        yield (0, (_electronBuilderUtil || _load_electronBuilderUtil()).exec)(process.platform === "win32" ? <span class="branch-0 cbranch-no" title="branch not covered" >"node-gyp.cmd" </span>: "node-gyp", ["rebuild"], {
            env: (0, (_yarn || _load_yarn()).getGypEnv)({ version: yield (0, (_readPackageJson || <span class="branch-1 cbranch-no" title="branch not covered" >_load_readPackageJson())</span>.getElectronVersion)(config, projectDir), useCustomDist: true }, args.platform, args.arch, true)
        });
    });
&nbsp;
